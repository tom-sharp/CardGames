...
namespace Games.Card.TexasHoldEm
{
	...
	*/
	...
	//public class TexasHoldEmPlayerCommonCards : TexasHoldEmPlayer
	//{

	//	public TexasHoldEmPlayerCommonCards() :base(Factory.Player(GamePlayerType.Default)) {
	//	}

	//	public override void InTurn(ITexasHoldEmTurnInfo info)
	//	{
	...
	//		DealPlayerCards(cards: 1);
	//		DealPlayerCards(cards: 1);
	//		ShowHumanCards();
	//		this.IO.ReDrawGameTable();
	//		PlaceBets();
	//		DealPublicCards(cards: 3);
	//		PlaceBets();
	//		DealPublicCards(cards: 1);
	//		PlaceBets();
	//		DealPublicCards(cards: 1);
	//		PlaceBets();
	//		FindWinner();
